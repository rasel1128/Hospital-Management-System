 ...
 * @author Walton
 */
public class Patient_MainMenuController implements Initializable {

    @FXML
    private TextField appoinment;
    @FXML
    ...
    private void insert(ActionEvent event) {
         ...
         String sql="INSERT INTO patient_mainmenu VALUES ('"+patient_id.getText()+"', '"+patient_name.getText()+"', '"+doctor_id.getText()+"', '"+doctor_name.getText()+"', '"+appoinment.getText()+"')";
    ...
    private void back(ActionEvent event) throws IOException {
        FXMLLoader fxmlLoader = new
          ...
          stage.setScene(new Patient_MainMenuController.scene(root2));
