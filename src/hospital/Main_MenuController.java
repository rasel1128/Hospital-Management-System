...
public class Main_MenuController implements Initializable {
    ...
    private void Administration(ActionEvent event) throws IOException {
         ...
         FXMLLoader(getClass().getResource("Administration.fxml"));
          ...
          stage.setScene(new Main_MenuController.scene(root2));
    ...
    @FXML
    private void Receptionist(ActionEvent event) throws IOException {
         FXMLLoader fxmlLoader = new
    ...
    private void Doctor(ActionEvent event) throws IOException {
       FXMLLoader fxmlLoader = new
         FXMLLoader(getClass().getResource("Doctor_MainMenu.fxml"));
           Parent root2;
           root2 = (Parent)fxmlLoader.load();
          Stage stage = new Stage();
          stage.setScene(new Main_MenuController.scene(root2));
    ...
    private void Patient(ActionEvent event) throws IOException {
         FXMLLoader fxmlLoader = new
         FXMLLoader(getClass().getResource("Patient_MainMenu.fxml"));
           Parent root2;
           root2 = (Parent)fxmlLoader.load();
          Stage stage = new Stage();
          stage.setScene(new Main_MenuController.scene(root2));
    ...
    private void Nurse(ActionEvent event) throws IOException {
         FXMLLoader fxmlLoader = new
         FXMLLoader(getClass().getResource("Nurse_MainMenu.fxml"));
           Parent root2;
           root2 = (Parent)fxmlLoader.load();
          Stage stage = new Stage();
          stage.setScene(new Main_MenuController.scene(root2));
    ...
    @FXML
    private void Pharmacy(ActionEvent event) throws IOException {
      FXMLLoader fxmlLoader = new
         FXMLLoader(getClass().getResource("Farmacy_MainMenu.fxml"));
           Parent root2;
           root2 = (Parent)fxmlLoader.load();
          Stage stage = new Stage();
          stage.setScene(new Main_MenuController.scene(root2));
